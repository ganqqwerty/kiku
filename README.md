...
языка в Anki. Функциональность и интерактивный интерфейс соответствуют Kiku RU 2.0.2, а видимые
...
Импортируйте `packages/note/.release/Kiku_RU_v2.0.2.apkg` через меню Anki
**Файл → Импортировать**.
...
в нём все исполняемые ресурсы, конфигурацию и шаблоны сборкой Kiku RU 2.0.2, обновляет тип заметки
