...
языка в Anki. Функциональность и интерактивный интерфейс соответствуют Kiku RU 2.0.3, а видимые
...
Импортируйте `packages/note/.release/Kiku_RU_v2.0.3.apkg` через меню Anki
**Файл → Импортировать**.
...
Команда `package-ru` использует официальный Kiku 2.0.0 как базовый контейнер коллекции, заменяет
в нём все исполняемые ресурсы, конфигурацию и шаблоны сборкой Kiku RU 2.0.3, обновляет тип заметки
